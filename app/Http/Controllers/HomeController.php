...
class HomeController extends Controller
{
    public function index(Request $request) {
        ...
        return view('home', compact('year','listTahun','listBulan', 'dataYPemasukan', 'dataYPengeluaran', 'pemasukanTotal', 'pengeluaranTotal', 'saldoTotal', 'dataXPemasukanPerDepartemen', 'dataYPemasukanPerDepartemen', 'dataXPengeluaranPerDepartemen', 'dataYPengeluaranPerDepartemen', 'dataXPemasukanPerKategori', 'dataYPemasukanPerKategori', 'dataXPengeluaranPerKategori', 'dataYPengeluaranPerKategori'));
    }
}
