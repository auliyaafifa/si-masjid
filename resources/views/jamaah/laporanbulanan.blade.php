...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <select id="bulan" class="form-select" name="bulan" onchange="this.form.submit()">
                                ...
                                <option value="{{ $index + 1 }}" @selected((request('bulan') ?? now()->month) == $index + 1)>{{ $bulan }}
                                </option>
                                @endforeach
                            </select>
                        </div>
            ...
            <a href="/jamaah/laporan/bulanan/export_excel?departemen={{request('departemen')}}&tahun={{request('tahun')}}&bulan={{request('bulan')}}" class="btn btn-success">Export Excel</a><br>
